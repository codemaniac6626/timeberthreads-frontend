...
import { IconMoon, IconShoppingBag, IconSun } from "@tabler/icons-react";
    ...
    <UserContextMenu>
      <Tooltip label={username}>
        <Button
          ...
          h={"100%"}
          leftSection={
            <Avatar src={profilePic} variant="transparent" size={"md"}></Avatar>
          }
        />
      </Tooltip>
    </UserContextMenu>
          ...
          <Group>
            ...
            <Indicator
              ...
              label={
                cart && (
                  <Center>
                    <Text style={{ cursor: "pointer" }} fz={8}>
                      {totalCartLength}
                    </Text>
                  </Center>
                )
